...
export const getUser = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get("https://portfolio-aq-25d3.up.railway.app/api/v1/user/me", {
...
export const logout = () => async (dispatch) => {
  try {
    const { data } = await axios.get(
      "https://portfolio-aq-25d3.up.railway.app/api/v1/user/logout",
      { withCredentials: true }
    );
  ...
  (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.put(
        "https://portfolio-aq-25d3.up.railway.app/api/v1/user/update",
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://portfolio-aq-25d3.up.railway.app/api/v1/user/me/profile/update",
      data,
      {
        withCredentials: true,
