...
import { generateToken } from "../utils/jwtToken.js"; // ✅ correct path to token function
...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  // ✅ 2. Check file upload (avatar and resume)
  ...
  // ✅ 5. Extract user data from form body
  const {
    fullName,
    email,
    phone,
  ...
  // ✅ 7. Generate JWT and send response
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "683af6bb83af0975aa41d934"; // Use a valid ID from your DB
